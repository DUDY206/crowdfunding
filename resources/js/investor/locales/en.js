export default {
    ...
    sign_up_now_under_list: {
        ...
        ans1: 'BestB Crowdfunding is a crowdfunding platform, everyone, to invest in Vietnamese businesses. We allow ordinary people, not just professional investors - to invest in businesses that have been thoroughly appraised and tested by BestB Capital Investment Fund, with a minimum of 500,000 VND per investment ',
        ans1_1: 'BestB Crowdfunding is created to popularize fundraising to expand financial investment to the public, providing an opportunity for anyone to participate in businesses that could be unicorn startups in the future.',
        ans2: 'As part of our commitment to expanding investment access to everyone, the BestB Crowdfunding platform allows investors to start investments with a minimum of 500,000 VND. above.',
        ...
        ans5: 'BestB Crowdfunding is a highly regulated platform. We only recommend businesses that have been selected through the appraisal process and are thoroughly analyzed by the expert panel. To be listed on the BestB Crowdfunding platform, businesses need to submit a complete and detailed application. The businesses on our platform span a wide range of start-up stages, industry sectors and business models, so you can better diversify your portfolio.',
        ans5_1: 'Note: While we take great care in vetting startups, we cannot guarantee 100% the accuracy of the information they provide. Develop your own analytic and informed thinking, review each offering carefully and only invest in companies you trust and have done your due diligence on',
        ans6: "Register! We've worked hard to roll out corporate investment packages - which is normally a process that takes days and involves lawyers and costs money - but is as easy as an online investment. line. It only takes a few seconds to invest on the BestB Crowdfunding platform and start investing via bank transfer and you will be provided with an electronic contract with BestB Capital",
        ans6_1: 'We encourage you to review the materials we provide and do your own research and learn about the companies you want to invest in',
        ans7: 'BestB Crowdfunding is an investment crowdfunding (or equity) platform, which means that on the BestB Crowdfunding platform investors can expect a return. They perceive and believe that the startup will be successful, so they decide to buy a part of the future of the business.',
        ans8: 'BestB Crowdfunding is free for investors, no hidden fees or future costs. Crowdfunding BestB Crowdfunding only charges the fundraising company and investors with other investment transaction needs for businesses.',
        ...
        ans10: 'Startups are companies with a "stock ticker" that has not been publicly traded. The public stock market only lists public companies - that have gone through an IPO - often long after they have achieved certain growth and conditions.',
        ans10_1: 'Becoming an investor on the BestB Crowdfunding platform allows you to buy shares at the early stages of a startup, before the IPO with lots of room to grow. When you put your capital at risk of losing it all, you are also betting on the opportunity to grow your finances exponentially.',
    },
    home: {
        home: 'Home',
        invest: "Invest",
