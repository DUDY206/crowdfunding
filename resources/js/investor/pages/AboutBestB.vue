<template>
    <b-container fluid="lg">
        ...
        <div v-if="!isLoading" class="title-page">{{ $t('header_banner.about') }}</div>
        <div v-if="!isLoading" class="wrapper-boxs">
            <div class="box">
            ...
            <hr />
            <div class="box">
                <div class="title">{{ $t('about.vision') }}</div>
                <div class="content">
                    {{ $t('about.content_vision') }}
                </div>
            </div>
            <hr />
        </div>
